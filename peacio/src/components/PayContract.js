...
function PayContract() {
	...
	const stableCoinAmount = Math.round(contractAmount/ (10 ** 6));

        let argArr = [contractNumber, sellerAddress.address, notary.address, salesRelease, disputeRelease, contractAmount  ];
